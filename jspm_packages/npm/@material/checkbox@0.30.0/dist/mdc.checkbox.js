  ...
  (function webpackUniversalModuleDefinition(root, factory) {
    ...
    return (function(modules) {
      ...
      48: (function(module, __webpack_exports__, __webpack_require__) {
        ...
        var __WEBPACK_IMPORTED_MODULE_2__material_selection_control_index__ = __webpack_require__(9);
        var __WEBPACK_IMPORTED_MODULE_3__foundation__ = __webpack_require__(49);
      ...
      49: (function(module, __webpack_exports__, __webpack_require__) {
        ...
        var __WEBPACK_IMPORTED_MODULE_1__material_selection_control_index__ = __webpack_require__(9);
        var __WEBPACK_IMPORTED_MODULE_2__adapter__ = __webpack_require__(50);
        var __WEBPACK_IMPORTED_MODULE_3__constants__ = __webpack_require__(51);
        var _extends = Object.assign || function(target) {
          for (var i = 1; i < arguments.length; i++) {
            var source = arguments[i];
            for (var key in source) {
      ...
      50: (function(module, __webpack_exports__, __webpack_require__) {
        "use strict";
        var __WEBPACK_IMPORTED_MODULE_0__material_selection_control_index__ = __webpack_require__(9);
        var _createClass = function() {
          function defineProperties(target, props) {
            for (var i = 0; i < props.length; i++) {
              var descriptor = props[i];
