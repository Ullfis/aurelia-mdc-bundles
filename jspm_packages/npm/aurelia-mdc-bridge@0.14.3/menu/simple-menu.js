...
define(["require", "exports", "aurelia-framework", "aurelia-logging", "@material/menu", "../util"], function (require, exports, aurelia_framework_1, aurelia_logging_1, menu_1, util) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MdcSimpleMenuOpenFrom = {
        topLeft: 'top-left',
        topRight: 'top-right',
    ...
    var MdcSimpleMenu = (function () {
        function MdcSimpleMenu(element, taskQueue) {
            ...
            this.log = aurelia_logging_1.getLogger('mdc-simple-menu');
        }
        ...
        MdcSimpleMenu.prototype.attached = function () {
            ...
            this.mdcSimpleMenu = new menu_1.MDCSimpleMenu(this.elementSimpleMenu);
        ...
        MdcSimpleMenu.prototype.openFromChanged = function (newValue) {
            this.elementSimpleMenu.classList.remove('mdc-simple-menu--open-from-' + exports.MdcSimpleMenuOpenFrom.topLeft);
            this.elementSimpleMenu.classList.remove('mdc-simple-menu--open-from-' + exports.MdcSimpleMenuOpenFrom.topRight);
            this.elementSimpleMenu.classList.remove('mdc-simple-menu--open-from-' + exports.MdcSimpleMenuOpenFrom.bottomLeft);
            this.elementSimpleMenu.classList.remove('mdc-simple-menu--open-from-' + exports.MdcSimpleMenuOpenFrom.bottomRight);
            if (newValue) {
        ...
        MdcSimpleMenu = __decorate([
            ...
            aurelia_framework_1.customElement('mdc-simple-menu'),
