/* */ 
"format cjs";
System.register(["aurelia-framework", "aurelia-logging", "@material/toolbar", "../util"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_logging_1, toolbar_1, util, MdcToolbar;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_1("MdcToolbar", MdcToolbar);
        }
    };
});
