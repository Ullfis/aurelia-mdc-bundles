...
System.register(["aurelia-framework", "aurelia-logging", "@material/menu", "../util"], function (exports_1, context_1) {
    ...
    var aurelia_framework_1, aurelia_logging_1, menu_1, util, MdcSimpleMenuOpenFrom, MdcSimpleMenu;
    return {
        setters: [
        ...
        execute: function () {
            exports_1("MdcSimpleMenuOpenFrom", MdcSimpleMenuOpenFrom = {
                topLeft: 'top-left',
                topRight: 'top-right',
            ...
            exports_1("MdcSimpleMenu", MdcSimpleMenu);
        }
    };
});
